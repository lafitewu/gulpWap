...
EndlessScroll = (function() {
  ...
  EndlessScroll.prototype.wrapContainer = function(target) {
    if (this.innerWrap.length === 0) {
      return this.innerWrap = $(target).find('ul').wrap('<div class="endless_scroll_content" data-page="0" />').wrapInner('<div class="endless_scroll_inner_wrap" />').find('.endless_scroll_inner_wrap');
    }
  };
  ...
  EndlessScroll.prototype.calculateScrollableCanvas = function() {
    if (this.target[0] === document || this.target[0] === window) {
      this.wrapContainer("body " + this.options.innerWrapClass);
  ...
  EndlessScroll.prototype.resetAgus = function(){
    this.firing = true;
    this.didScroll = true;
    this.fireSequence = 0;
    this.nextSequence = 1;
...
(function($) {
  return $.fn.endlessScroll = function(options) {
    var ret = new EndlessScroll(this, options);
    ret.run();
    return ret;
  };
})(Zepto);
